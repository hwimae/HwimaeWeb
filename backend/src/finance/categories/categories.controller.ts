...
import type { FinanceCategoriesService } from './categories.service';

export type FinanceCategoriesController = {
  list: RequestHandler;
...
export function createFinanceCategoriesController(service: FinanceCategoriesService): FinanceCategoriesController {
  return {
